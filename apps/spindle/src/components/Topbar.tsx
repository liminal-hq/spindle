...
export function Topbar() {
		...
		sections: [
			{
				items: [
					...
					{ id: 'maximize', label: isMaximised ? 'Restore' : 'Maximise' },
				],
			},
		...
		<>
			<div className="topbar__logo" data-tauri-drag-region>
				<svg className="logo-mark" viewBox="0 0 24 24" fill="none">
					...
					<path
						d="M4 4 L8 4 L8 6 L6 6 L6 18 L8 18 L8 20 L4 20 Z"
						stroke="url(#logo-grad)"
						strokeWidth="1.5"
						fill="none"
					/>
					<path
						d="M20 4 L16 4 L16 6 L18 6 L18 18 L16 18 L16 20 L20 20 Z"
						stroke="url(#logo-grad)"
						strokeWidth="1.5"
						fill="none"
					/>
	...
	return (
		<>
			<header
				className={`topbar is-${platformType}`}
