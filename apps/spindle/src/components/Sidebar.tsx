...
const ICONS = {
	...
	settings: (
		<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
			...
			<path d="M7 1h2v1.5a5 5 0 0 1 1.5.6l1-1 1.4 1.4-1 1a5 5 0 0 1 .6 1.5H14v2h-1.5a5 5 0 0 1-.6 1.5l1 1-1.4 1.4-1-1a5 5 0 0 1-1.5.6V14H7v-1.5a5 5 0 0 1-1.5-.6l-1 1-1.4-1.4 1-1A5 5 0 0 1 3.5 9H2V7h1.5a5 5 0 0 1 .6-1.5l-1-1 1.4-1.4 1 1A5 5 0 0 1 7 3.5z" />
		</svg>
	),
};
