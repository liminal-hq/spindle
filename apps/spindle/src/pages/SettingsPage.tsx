				...
				<div className="settings__dev-options">
					...
					<label className="settings__toggle-row">
						<div className="settings__toggle-text">
							...
							<span className="settings__toggle-desc text-muted">
								Render menu overlays with anti-aliasing enabled and quantise the result to a 4-entry
								palette. Use this to preview and verify AA+quantised overlay output without building
								a full disc.
							</span>
						</div>
						<input
