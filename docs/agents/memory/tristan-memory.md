...
- What the baseline keyboard-navigation contract should be for the menu-preview experience.
- Which accessibility checks should become part of the default handoff for new UI features.
